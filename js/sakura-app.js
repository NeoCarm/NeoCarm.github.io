...
$(function () {
  ...
  console.log('%c NeoCarm %c', 'background:#24272A; color:#ffffff', '', 'https://neocarm.github.io')
  console.log('%c Github %c', 'background:#24272A; color:#ffffff', '', 'https://github.com/NeoCarm')
})
